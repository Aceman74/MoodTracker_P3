...
/**
 * <b>VeryHappy class</b> with view VeryHappy Mood and three buttons:<br>
...
public class VeryHappyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer clickSmiley = MediaPlayer.create(this,R.raw.very_happy);  // sound on smiley click
        final Animation shake = AnimationUtils.loadAnimation(this,R.anim.shake_anim);   // anim on smiley click
        loadData();

        findViewById(R.id.activity_very_happy_frame);
        ...
        mSmiley.setOnClickListener(v -> {
            MoodSaveList.add(7, new MoodSave(Today(),"very_happy", mIsNote,mAddNote));
            saveData();
        ...
        mNote.setOnClickListener(v -> {
            NoteMaker newNote = new NoteMaker(VeryHappyActivity.this);
     ...
     * @return better mood if swipe down
     * @see MainHappyActivity swipe down
     */
    @Override
